...
const Dashboard = () => {
  ...
  const deleteSession = async (sessionId) => {
    ...
    try {
      ...
      // Optional: clear active session if deleted
                ...
                <div style={{ padding: "0 0.5rem" }}>
                  ...
                  <div
                    style={{
                      height: "1px",
                      background:
                        "linear-gradient(90deg, rgba(255,183,197,0) 0%, rgba(255,183,197,0.5) 50%, rgba(255,183,197,0) 100%)",
                      margin: "2rem 0",
                    }}
                  />
